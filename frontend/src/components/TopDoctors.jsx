...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            <h1 className='text-3xl font-medium'>Top-Rated Doctors for Appointment</h1>
            <p className='sm:w-1/3 text-center text-sm'>Explore our wide range of trusted doctors.</p>
