            ...
            {/** ---------------- ADMIN SIDEBAR ---------------- */}
            {
                aToken && <ul className='text-[#515151] mt-5'>
                    ...
                    <NavLink className={({ isActive }) =>
                        ...
                        <img className="w-8 h-8" src={assets.bed_icon} alt="" />
                    ...
                    <NavLink
                        className={({ isActive }) =>
                            `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer 
        ${isActive ? 'bg-[#E8FFF2] border-r-4 border-green-500' : ''}`
                        }
                        to='/admin-patient-records'
                    >
                        <img className='w-7 h-7' src={assets.records_icon} alt='' />
            ...
            ${isActive ? 'bg-[#E8FFF2] border-r-4 border-green-500' : ''}`
                        ...
                        <img className='w-8 h-8' src={assets.record_icon} alt="" />
            ...
            ${isActive ? 'bg-[#E8FFF2] border-r-4 border-green-500' : ''}`
                        ...
                        <img className='w-8 h-8' src={assets.records_icon} alt="" />
